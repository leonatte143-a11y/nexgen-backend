...
function humanizeAction(action, meta) {
  ...
  const map = {
    ...
    marketplace_listing_ban: meta?.label || 'Banned marketplace listing',
    marketplace_listing_delete: meta?.label || 'Deleted marketplace listing',
    category_delete: meta?.label || 'Deleted service category',
    service_delete: meta?.label || 'Archived service',
    partner_restore: meta?.label || 'Restored archived partner',
