...
import { listPartnerReviews, listMyReviews } from '../controllers/reviewController.js';
...
r.post('/requests/:id/confirm-cash', c.confirmCashReceived);
...
r.get('/reviews/mine', listMyReviews);
